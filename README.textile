...
p. I found there is no javascript and css links at all in my html file rendered out!!
...
p. Do I need to surround #{greenscript } tag with #{set 'moreStyles'} in my other templates?
...
p. How to use GreenScript? Is it hard to configure?
